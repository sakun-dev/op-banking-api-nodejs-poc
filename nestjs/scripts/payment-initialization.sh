...
echo "Hello World!"
# Copy of
# https://github.com/op-developer/op-online-payment-api-examples/blob/main/payment-initialization.sh
# of course some details might have been edited in order to run this
...
API_KEY="6c18c234b1b18b1d97c7043e2e41135c293d0da9"
